...
typedef enum {
    GCDiscreetNotificationViewPresentationModeTopiPad,
    GCDiscreetNotificationViewPresentationModeBottomiPad,
} GCDiscreetNotificationViewPresentationModeiPad;

@interface GCDiscreetNotificationViewiPad : UIView
...
@property (nonatomic, assign) GCDiscreetNotificationViewPresentationModeiPad presentationMode;
...
- (id) initWithText:(NSString *)text showActivity:(BOOL)activity inPresentationMode:(GCDiscreetNotificationViewPresentationModeiPad) aPresentationMode inView:(UIView *)aView;
