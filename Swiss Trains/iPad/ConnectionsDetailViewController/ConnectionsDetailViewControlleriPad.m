...
@interface ConnectionsDetailViewControlleriPad ()

@end

@implementation ConnectionsDetailViewControlleriPad
...
- (id)initWithFrame:(CGRect)viewFrame
{
    ...
    if (self) {
        ...
        [self.detailViewTableView registerClass:[ConnectionsDetailviewCelliPad class] forCellReuseIdentifier: @"ConnectionsDetailviewCell"];
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //self.detailViewTableView.backgroundColor = [UIColor detailTableviewBackgroundColor];
        //self.detailViewTableView.backgroundColor = [UIColor listviewControllersBackgroundColor];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass: [ConnectionsDetailviewCelliPad class]]) {
        ...
        ConnectionsDetailviewCelliPad *detailViewCell = (ConnectionsDetailviewCelliPad
                                                         *)cell;
        ...
        //NSLog(@"Walk: %@, %@, %@, %@", startStationName, [[[conSection departure] station] stationId], endStationName,[[[conSection arrival] station] stationId] );
        ...
        if (journeyTypeFlag == walkType) {
            ...
            //NSLog(@"Tracks: %d, %@, %@", indexPath.row, startTrack, endTrack);
        ...
        UIImage *transportConnectionImage = [[SBBAPIController sharedSBBAPIController] renderTransportConnectionImageForConsection: conSection size: CGSizeMake(40, 154) topLine:topLine bottomLine: bottomLine];
...
- (void)longPress:(UILongPressGestureRecognizer *)gesture
{
	...
	if (gesture.state == UIGestureRecognizerStateBegan)
	{
        ...
        if ([conSection conSectionType] == walkType) {
            ...
            {
                [self.delegate didTriggerDetailviewCellWithIndexLongPress:self index: indexPath.row viewrect:selectedCell.frame];
            }
        }
	}
}
...
-(NSIndexPath *)tableView:(UITableView *)tableView willSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ConnectionsDetailviewCelliPad *selectedCell = (ConnectionsDetailviewCelliPad *)[tableView cellForRowAtIndexPath: indexPath];
    
    if ([selectedCell isKindOfClass:[ConnectionsDetailviewCelliPad class]]) {
        //ConnectionsDetailviewCelliPad *selectedCell = (ConnectionsDetailviewCelliPad *)[tableView cellForRowAtIndexPath: indexPath];
