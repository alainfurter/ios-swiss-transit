...
@implementation CircleImageViewiPad
...
@implementation ConnectionsOverviewCelliPad
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        backgroundViewFrame.size.height = 154;
        ...
        self.timeLabelMinutesBig = [[UILabel alloc] initWithFrame: CGRectMake(8, 20 - 5, 70, 40)];
        ...
        self.timeLabelMinutesBigTitle = [[UILabel alloc] initWithFrame: CGRectMake(11, 70 - 5, 60, 10)];
        ...
        */
        ...
        self.timeLabelHoursSmall = [[UILabel alloc] initWithFrame: CGRectMake(15, 20 - 5, 70, 30)];
        //self.timeLabelHoursSmall.font = [UIFont systemFontOfSize:20.0];
        ...
        self.timeLabelHoursSmallTitle = [[UILabel alloc] initWithFrame: CGRectMake(45, 22 - 5, 32, 30)];
        //self.timeLabelHoursSmall.font = [UIFont systemFontOfSize:20.0];
        ...
        self.timeLabelMinutesSmall = [[UILabel alloc] initWithFrame: CGRectMake(15, 50 - 5, 70, 30)];
        //self.timeLabelMinutesSmall.font = [UIFont systemFontOfSize:20.0];
        ...
        self.timeLabelMinutesSmallTitle = [[UILabel alloc] initWithFrame: CGRectMake(45, 53 - 5, 32, 30)];
        //self.timeLabelMinutesSmall.font = [UIFont systemFontOfSize:20.0];
        ...
        */
        ...
        self.changesImageView = [[CircleImageViewiPad alloc] initWithFrame: CGRectMake(18, 85 - 5, 20, 20) centerImage: [UIImage journeyChangesImage]];
         
        self.changesLabel = [[UILabel alloc] initWithFrame: CGRectMake(43, 85 - 5, 20, 20)];
        //self.timeLabelMinutesSmall.font = [UIFont systemFontOfSize:20.0];
        ...
        self.departureImageView = [[UIImageView alloc] initWithFrame: CGRectMake(8, 110, 20, 10)];
        ...
        self.arrivalImageView = [[UIImageView alloc] initWithFrame: CGRectMake(8, 129, 20, 10)];
        ...
        self.departureTimeLabel = [[UILabel alloc] initWithFrame: CGRectMake(35, 110, 50, 12)];
        //self.timeLabelMinutesBigTitle.font = [UIFont systemFontOfSize:12.0];
        ...
        self.arrivalTimeLabel = [[UILabel alloc] initWithFrame: CGRectMake(35, 128, 50, 12)];
        //self.timeLabelMinutesBigTitle.font = [UIFont systemFontOfSize:12.0];
        ...
        self.connectionInfoImageView = [[UIImageView alloc] initWithFrame: CGRectMake(55, 85 - 5, 20, 20)];
