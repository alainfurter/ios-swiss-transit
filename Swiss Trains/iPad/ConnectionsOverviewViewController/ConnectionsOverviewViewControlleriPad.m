...
@interface ConnectionsOverviewViewControlleriPad ()

@end

@implementation ConnectionsOverviewViewControlleriPad
...
- (id)initWithFrame:(CGRect)viewFrame
{
    ...
    if (self) {
        ...
        [self.overViewTableView registerClass:[ConnectionsOverviewCelliPad class] forCellReuseIdentifier: @"ConnectionsOverviewCell"];
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //self.overViewTableView.backgroundColor = [UIColor overviewTableviewBackgroundColor];
        self.overViewTableView.backgroundColor = [UIColor listviewControllersBackgroundColor];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    ConnectionsOverviewCelliPad *overViewCell = (ConnectionsOverviewCelliPad *)cell;
    //if (NO) {
