...
const NSTimeInterval kSDSegmentedControlDefaultDuration = 0.1;
const CGFloat kSDSegmentedControlArrowSize = 6.5;
const CGFloat kSDSegmentedControlInterItemSpace = 50.0;
//const UIEdgeInsets kSDSegmentedControlStainEdgeInsets = {-2, -16, -4, -16};
const UIEdgeInsets kSDSegmentedControlStainEdgeInsets = {-2, -26, -2, -26};
...
- (UIImage *)greyGradientPatternImage {
    ...
    CGSize segmentedControlSize = CGSizeMake(REQSEGCONTROLWIDTH, REQSEGCONTROLHEIGHT);
    ...
    CGRect currentBounds = CGRectMake(0, 0, segmentedControlSize.width, segmentedControlSize.height);
...
- (void)commonInit
{
    ...
    self._selectedStainView.backgroundColor = [UIColor requestSegmentedControlItemViewBackgroundColor];
}
...
+ (void)initialize
{
     ...
     */
    [appearance setTitleColor:[UIColor requestSegmentedControlItemViewTextColorNormal] forState:UIControlStateNormal];
    [appearance setTitleShadowColor:[UIColor requestSegmentedControlItemViewTextColorNormalShadow] forState:UIControlStateNormal];
    
    [appearance setTitleColor:[UIColor requestSegmentedControlItemViewTextColorSelected] forState:UIControlStateSelected];
    [appearance setTitleShadowColor:[UIColor requestSegmentedControlItemViewTextColorSelectedShadow] forState:UIControlStateSelected];
    
    [appearance setTitleColor:[UIColor requestSegmentedControlItemViewTextColorDisabled] forState:UIControlStateDisabled];
    [appearance setTitleShadowColor:[UIColor requestSegmentedControlItemViewTextColorDisabledShadow] forState:UIControlStateDisabled];
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        self.titleEdgeInsets = UIEdgeInsetsMake(0, 0.0, 0, 0.0); // Space between text and image
        self.imageEdgeInsets = UIEdgeInsetsMake(0, 0.0, 0, 0.0); // Space between image and stain
        self.contentEdgeInsets = UIEdgeInsetsMake(0, 0.0, 0, 0); // Enlarge touchable area
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor requestSegmentedControlItemViewInnerCircleBottomShadowColor].CGColor);
    CGContextStrokePath(context);
}
