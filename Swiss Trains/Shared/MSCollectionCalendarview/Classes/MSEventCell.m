...
- (void)setConsection:(ConSection *)consection
{
...
- (void)updateColors
{
    UIColor *transportColor = [[SBBAPIController sharedSBBAPIController] getTransportColorWithConsection: self.consection];
    
    //self.contentView.backgroundColor = [self cellBackgroundColorSelected:self.selected];
    self.contentView.backgroundColor = [transportColor colorWithAlphaComponent:0.5];
