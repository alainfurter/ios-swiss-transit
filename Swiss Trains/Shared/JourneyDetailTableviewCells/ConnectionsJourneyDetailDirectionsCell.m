...
@implementation ConnectionsJourneyDetailDirectionsCell
...
+ (void)initialize {
    if (self == [ConnectionsJourneyDetailDirectionsCell class]) {
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        */
        ...
        self.instructionsLabel = [[UILabel alloc] initWithFrame: CGRectMake(75 + 30, 10, 320 - 80 - 75 - 10 - 30, 15)];
        //self.titleLabel.tag = kCellTitleLabelTag;
...
+ (CGFloat)neededHeightForManeuver:(MTDManeuver *)maneuver constrainedToWidth:(CGFloat)width {
    ...
    */
    ...
    CGFloat innerWidth = 320 - 80 - 75 - 10.f;
    CGSize constraint = CGSizeMake(innerWidth, CGFLOAT_MAX);
